...
const Home = () => {
	return (
		<div className="text-slate-100 px-20">
			<h2 className="text-3xl py-10 text-slate-400 text-bold md:pt-20">Lorem ipsum</h2>
			<div className="flex flex-col-reverse lg:flex-row justify-center items-center">
				<div className="text-lg text-slate-300 lg:w-1/2">
					<p className="px-2 my-4 lg:mt-12 lg:tracking-normal lg:leading-10 lg:text-2xl lg:text-left">
				...
				<div className="w-80 h-auto lg:w-1/3">
					<img src={svg1} alt="svg" className="w-full h-full" />
				</div>
			</div>
			<hr className="border-b border-slate-500 mx-6 md:my-20 my-10" />
			<h3 className="text-slate-400 text-2xl lg:mt-20">About</h3>
			<div className="flex flex-col lg:flex-row justify-center items-center">
				<div className="w-80 h-auto lg:w-96">
					<img src={svg2} alt="svg" className="w-full" />
				</div>
				<p className="text-slate-300 mx-2 lg:leading-7 lg:w-1/2">
			...
			<footer className="mt-16 bg-slate-700">
				<div className="text-center bg-gray-900 text-white">
					<div className="flex justify-center mx-auto pt-6">
						<p className="rounded-full border-2 border-white text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1">
